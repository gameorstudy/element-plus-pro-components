...
import { type ProFormProps, proFormPropsDefaults, type ProFormSubmitterProps } from './pro-form';
...
// Props
const props = withDefaults(defineProps<ProFormProps>(), proFormPropsDefaults)
...
const submitterProps = computed(() => {
  if (props.submitter) {
    // Button Text
    const defaultTextConfig: ProFormSubmitterProps = {
...
// emit
const emit = defineEmits(['onReset', 'onFinish', 'onError'])
